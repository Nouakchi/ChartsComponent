...
const data = {
      ...
      datasets: [
        {
            label: 'Votes for Donald trump',
            data: [1584651, 958448, 6006429, 669890, 554119, 343602, 193559],
            borderWidth: 1,
            backgroundColor: [
              'rgba(255, 99, 132)',
              'rgba(255, 159, 64)',
